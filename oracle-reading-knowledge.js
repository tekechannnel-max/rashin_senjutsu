  ...
  const loveSubtypes={
    reconciliation:{
      oracle:{
        ...
        compassFallback:'今の羅針盤は、まだ好きかどうかを測ることではなく、過去の原因へ向き合える関係かを見ることです。懐かしさで戻る前に、信頼を作り直せる会話ができるかが大切です。',
        messageFallback:'ここまでのあなたは、元恋人とのつながりを切りきれないまま、もう一度信頼を作れるのかを見極めようとしてきたはずです。今は、懐かしさではなく、過去の原因に向き合える反応があるかが分かれ目です。',
        replacements:[
          ['ここまでのあなたは、自分なりのやり方で何とか持ちこたえてきたはずです。','ここまでのあなたは、元恋人とのつながりを切りきれないまま、もう一度信頼を作れるのかを見極めようとしてきたはずです。'],
          ['一人で抱え込むより','相手の本気度を一人で想像し続けるより'],
          ['選択肢を増やしてから動く','過去の原因に向き合ってから動く'],
