...
assert.match(approvedPublisher, /miniCharacters/, 'approved reel publisher must require explicit mini character proof');
...
assert.match(guard, /APPROVED_POST_MISSING_MINI_CHARACTER_PROOF/, 'social guard must require approved reel mini character proof');
