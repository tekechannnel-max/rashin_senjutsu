...
木曜日20:00は比較系3枚カルーセルを優先します。木曜日21:00 / 23:00は通常の生まれ日リール枠です。木曜日20:00に日次リールを入れず、2026-06-27以降は22:00の日次リールも作りません。
...
- 夜の生まれ日動画: 夜20:00 / 21:00 / 23:00。素材は `videos/social/instagram/【インスタ】あるある・ランキング系/` を正本にします。InstagramはReels、Threadsは動画投稿として扱います。ThreadsとInstagramに同じ趣旨で出し、ハッシュタグだけ分けます。自動リサーチ対象は `生まれ日あるある/取説`、`生まれ日グラフ(1〜31日全て網羅)`、`○○な生まれ日TOP5` です。
